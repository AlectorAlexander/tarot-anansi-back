...
import { ISchedules, schedulesValidationSchema } from '../../modules/schedules/dtos/schedules.dtos';
...
import { ErrorTypes } from '../../modules/users/service/users.service';

// Create a mock SchedulesModel for testing purposes
jest.mock('../../modules/schedules/entities/schedules.entity');
const MockSchedulesModel = SchedulesModel as jest.MockedClass<typeof SchedulesModel>;
...
describe('SchedulesService', () => {
  ...
  describe('create', () => {
    it('should create a new schedule', async () => {
      ...
      MockSchedulesModel.prototype.create.mockResolvedValue(scheduleData as ISchedules & Document);
      ...
      expect(MockSchedulesModel.prototype.create).toHaveBeenCalledWith(scheduleData);
    ...
    it('should throw an error when schedule data validation fails', async () => {
      ...
      schedulesValidationSchema.safeParse = jest.fn().mockReturnValue({ success: false });

      await expect(schedulesService.create(invalidScheduleData)).rejects.toThrowError(validationError);

      // Ensure schedulesValidationSchema.safeParse is called with the correct arguments
      expect(schedulesValidationSchema.safeParse).toHaveBeenCalledWith(invalidScheduleData);
    });
  });
  ...
  describe('read', () => {
    it('should return a list of schedules', async () => {
      ...
      MockSchedulesModel.prototype.read.mockResolvedValue(schedulesData as ISchedules[] & Document[]);
  ...
  describe('readOne', () => {
    it('should return a schedule by its ID', async () => {
      ...
      MockSchedulesModel.prototype.readOne.mockResolvedValue(scheduleData as ISchedules & Document);
      ...
      expect(MockSchedulesModel.prototype.readOne).toHaveBeenCalledWith(scheduleId);
  ...
  describe('findByUserId', () => {
    it('should return a list of schedules for a given user ID', async () => {
      ...
      expect(MockSchedulesModel.prototype.read).toHaveBeenCalledWith({ user_id: userId });
    ...
    it('should return an empty list when no schedules are found for a user', async () => {
      ...
      MockSchedulesModel.prototype.read.mockResolvedValue([] as ISchedules[] & Document[]);
  ...
  describe('update', () => {
    it('should update a schedule and return the updated schedule', async () => {
      ...
      MockSchedulesModel.prototype.update.mockResolvedValue(newScheduleData as ISchedules & Document);

      const updatedSchedule = await schedulesService.update(scheduleId, newScheduleData);

      // Ensure SchedulesModel.update is called with the correct arguments
      expect(MockSchedulesModel.prototype.update).toHaveBeenCalledWith(scheduleId, newScheduleData);
    ...
    it('should return null when the schedule is not found', async () => {
      ...
      const updatedSchedule = await schedulesService.update(scheduleId, scheduleData);

      // Ensure SchedulesModel.update is called with the correct arguments
      expect(MockSchedulesModel.prototype.update).toHaveBeenCalledWith(scheduleId, scheduleData);
  ...
  describe('delete', () => {
    it('should delete a schedule and return the deleted schedule', async () => {
      ...
      MockSchedulesModel.prototype.delete.mockResolvedValue(deletedScheduleData as ISchedules & Document);
      ...
      expect(MockSchedulesModel.prototype.delete).toHaveBeenCalledWith(scheduleId);
